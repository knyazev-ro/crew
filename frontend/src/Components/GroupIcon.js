  ...
  return (
    <div className="">
      <div className={classNames("flex transition-all duration-300 ease-in-out",
        ...
        <button
          className="flex bg-pink-200 w-12 h-12 rounded-xl border hover:border-4 hover:border-indigo-500 hover:scale-105 hover:transition-transform transform-cpu"
          onClick={action}
        >
          {icon}
        </button>
