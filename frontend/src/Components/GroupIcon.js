  ...
  return (
    <div className="py-1">
      <div className={classNames("flex transition-all duration-300 ease-in-out",
        ...
        <button
          className="flex bg-gradient-to-t to-purple_sky-100 from-purple_sky w-12 h-12 rounded-xl border hover:border-4 hover:border-indigo-500 hover:scale-105 hover:transition-transform transform-cpu"
          onClick={action}
        >
          {icon}
        </button>
