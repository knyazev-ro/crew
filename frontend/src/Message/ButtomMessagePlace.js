...
export default function ButtomMessagePlace() {
  return (
    <>
      <div className="px-4 justify-around items-center absolute bottom-0 max-h-32 min-h-14 flex w-full bg-stone-100  transition-all border hover:border-b-indigo-600 hover:border-2">
        <div className="">
          <FontAwesomeIcon
            icon={faPaperclip}
