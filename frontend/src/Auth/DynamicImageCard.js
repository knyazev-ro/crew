export default function DynamicImageCard() {
  return (
    <div className="bg-purple_sky-100 w-full h-5/6 -translate-x-7 image-login flex">
      <div className="absolute bottom-2 left-2 w-2/12 h-28 bg-pink-600 flex">
        <div className="flex items-center">
          <div className="mx-2 h-24 bg-gray-400 w-11/12 flex">
